            ...
            <div class="wrapper fadeInDown">
                <div id="formContent">
                    ...
                    <div class="fadeIn first">
                        <h3 class="p-3"
                            style="border: rgba(47, 79, 79, 0.493) solid 2px; border-radius: 10px 10px 0 0;">
                            Registration Here</h3>
                    ...
                    <form name="registration" action="U_Regi_db.php" method="POST">
                        ...
                        <input type="text" id="login" class="fadeIn second" name="name2" placeholder="Last Name">
                        ...
                        <input type="password" id="login" class="fadeIn second" name="password"
