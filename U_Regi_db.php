...
<body>
    ...
    <div class="content">
        <div class="text-center mt-5 mb-5">
            ...
            $query = "select * from registration where user = '$user'";
            $query_run = mysqli_query($sql, $query);

            //same id check 
            if (mysqli_num_rows($query_run) == 1) {
                echo "<h2><b>Member user already exist. <br/>You can log in using your previous Member user and Password.</b></h2>";
            } else {
                $registration = "INSERT INTO registration values('$name','$name2','$email','$user','$password')";
