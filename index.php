...
<body>
    ...
    <div class="content">
        <img src="assets/image/p4.jpg" alt="" width="100%">
        <div class="row  mt-4">
            <div class="col-sm-4">
                <a href="grocery.php">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/image/p1.jpg" alt="" width="100%">
                        </div>
            ...
            <div class="col-sm-4">
                <a href="dress.php">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/image/p3.jpg" alt="" width="100%">
                        </div>
                        <div class="card-footer text-center">
                            Dresses
                        </div>
            ...
            <div class="col-sm-4">
                <a href="electronics.php">
                    <div class="card">
                        <div class="card-body">
                            <img src="assets/image/p2.jpg" alt="" width="100%">
                        </div>
                        <div class="card-footer text-center">
                            Electronics
                        </div>
